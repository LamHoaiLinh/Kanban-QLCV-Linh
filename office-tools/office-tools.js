...
const state = {
  ...
  imageFiles:[], imageComposer:{html:'',width:1080,format:'image/png',quality:92,bg:'#ffffff',normalizeText:true,name:'Noi_dung_dai'}, renameEntries:[], renameRootHandle:null, excelFiles:[],
