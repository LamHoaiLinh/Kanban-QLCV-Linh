...
{id:'carrot',name:'Cà rốt',level:1,seedCost:8,growMin:8,yield:3,basePrice:5,waterNeed:.55,disease:.20,exp:3,group:'rau',rarity:'thường',shape:'root',colors:['#3f9b4d','#f28c28']},
{id:'potato',name:'Khoai tây',level:1,seedCost:14,growMin:15,yield:4,basePrice:6,waterNeed:.45,disease:.18,exp:4,group:'củ',rarity:'thường',shape:'root',colors:['#559b48','#c99b62']},
{id:'lettuce',name:'Xà lách',level:2,seedCost:18,growMin:22,yield:4,basePrice:8,waterNeed:.72,disease:.24,exp:5,group:'rau',rarity:'thường',shape:'leaf',colors:['#71bd55','#a7df72']},
{id:'corn',name:'Bắp',level:3,seedCost:26,growMin:35,yield:5,basePrice:10,waterNeed:.58,disease:.22,exp:7,group:'rau',rarity:'thường',shape:'corn',colors:['#4e9e45','#f4cf43']},
{id:'tomato',name:'Cà chua',level:4,seedCost:35,growMin:50,yield:5,basePrice:14,waterNeed:.68,disease:.32,exp:9,group:'rau',rarity:'thường',shape:'berry',colors:['#41994c','#e94c3d']},
{id:'cabbage',name:'Bắp cải',level:5,seedCost:45,growMin:70,yield:5,basePrice:18,waterNeed:.70,disease:.28,exp:11,group:'rau',rarity:'thường',shape:'leaf',colors:['#4e9a63','#8ecb89']},
{id:'sweet_potato',name:'Khoai lang',level:6,seedCost:55,growMin:90,yield:5,basePrice:23,waterNeed:.42,disease:.18,exp:13,group:'củ',rarity:'thường',shape:'root',colors:['#559b48','#a85761']},
{id:'strawberry',name:'Dâu tây',level:7,seedCost:75,growMin:120,yield:4,basePrice:35,waterNeed:.75,disease:.38,exp:17,group:'trái',rarity:'khá',shape:'berry',colors:['#389548','#e73e4e']},
{id:'pumpkin',name:'Bí đỏ',level:8,seedCost:90,growMin:150,yield:4,basePrice:44,waterNeed:.48,disease:.20,exp:19,group:'rau',rarity:'khá',shape:'melon',colors:['#4f9849','#ed8b2e']},
{id:'onion',name:'Hành tây',level:9,seedCost:95,growMin:170,yield:5,basePrice:39,waterNeed:.45,disease:.18,exp:20,group:'củ',rarity:'khá',shape:'root',colors:['#4e9c52','#d9bd84']},
{id:'bell_pepper',name:'Ớt chuông',level:10,seedCost:115,growMin:200,yield:5,basePrice:48,waterNeed:.68,disease:.34,exp:23,group:'rau',rarity:'khá',shape:'berry',colors:['#399248','#e04b3d']},
{id:'watermelon',name:'Dưa hấu',level:11,seedCost:145,growMin:240,yield:3,basePrice:88,waterNeed:.72,disease:.28,exp:27,group:'trái',rarity:'khá',shape:'melon',colors:['#3d9046','#2e7d4e']},
{id:'pineapple',name:'Dứa',level:12,seedCost:165,growMin:270,yield:3,basePrice:102,waterNeed:.42,disease:.22,exp:29,group:'trái',rarity:'khá',shape:'pine',colors:['#4c9650','#d7a832']},
{id:'grape',name:'Nho',level:13,seedCost:205,growMin:320,yield:5,basePrice:78,waterNeed:.62,disease:.36,exp:34,group:'trái',rarity:'hiếm',shape:'vine',colors:['#448f4b','#7b55aa']},
{id:'orange',name:'Cam',level:14,seedCost:235,growMin:360,yield:4,basePrice:108,waterNeed:.55,disease:.26,exp:37,group:'trái',rarity:'hiếm',shape:'tree',colors:['#438d45','#ed8d2f']},
{id:'lemon',name:'Chanh',level:15,seedCost:250,growMin:390,yield:5,basePrice:92,waterNeed:.52,disease:.24,exp:39,group:'trái',rarity:'hiếm',shape:'tree',colors:['#438d45','#e5d84b']},
{id:'apple',name:'Táo',level:16,seedCost:300,growMin:450,yield:4,basePrice:130,waterNeed:.55,disease:.26,exp:45,group:'trái',rarity:'hiếm',shape:'tree',colors:['#438d45','#d94b4b']},
{id:'mango',name:'Xoài',level:18,seedCost:360,growMin:520,yield:4,basePrice:155,waterNeed:.48,disease:.23,exp:51,group:'trái',rarity:'hiếm',shape:'tree',colors:['#438d45','#f0b83f']},
{id:'dragon_fruit',name:'Thanh long',level:20,seedCost:430,growMin:600,yield:4,basePrice:185,waterNeed:.35,disease:.18,exp:58,group:'trái',rarity:'quý',shape:'cactus',colors:['#388c59','#e65f85']},
{id:'blueberry',name:'Việt quất',level:22,seedCost:520,growMin:720,yield:6,basePrice:148,waterNeed:.65,disease:.35,exp:65,group:'trái',rarity:'quý',shape:'berry',colors:['#3e8e4f','#4d5fa8']}
];
...
export const HELP_CONFIG={
 ...
 orders:['Có 3 ô đơn hàng. Hoàn thành đơn nhận Vàng, EXP và vật liệu.','Bỏ đơn sẽ phải chờ một khoảng thời gian trước khi có đơn mới.'],
