...
function openDiceGame(){if(!overlay){overlay=document.createElement('div');overlay.className='marble-draw-overlay';overlay.setAttribute('role','dialog');overlay.setAttribute('aria-label','Dice Arena');frame=document.createElement('iframe');frame.className='marble-draw-frame';frame.title='Dice Arena';frame.allow='fullscreen';overlay.appendChild(frame);document.body.appendChild(overlay)}frame.src='dice-game/index.html?v=5.6.0';overlay.hidden=false;document.body.classList.add('marble-draw-open')}
