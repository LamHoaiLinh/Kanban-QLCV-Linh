const CACHE_NAME='linh-kanban-static-v732-pdf-signing';
const ASSETS=[
  './','./index.html','./styles.css?v=6.21','./dragdrop.js?v=3.3','./app.js?v=3.7','./music-player.js?v=3.2',
  './office-tools/office-tools.css?v=4.4','./office-tools/office-tools.js?v=4.4','./office-tools/pdf-signing.js?v=1.0.0','./office-tools/excel-ai-analysis.mjs?v=1.0.0','./office-tools/vendor/jszip.min.js','./office-tools/downloads/KanBan_Signing_Agent_SETUP.zip',
