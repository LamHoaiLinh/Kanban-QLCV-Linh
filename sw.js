const CACHE_NAME='linh-kanban-static-v525-farm-v312-loader';
const ASSETS=[
  ...
  './game-launcher.js?v=1.0','./farm-game/index.html?v=3.1.2','./farm-game/styles.css?v=3.1.0','./farm-game/asset-loader.css?v=2.0.0','./farm-game/config.js?v=3.1.0','./farm-game/game-loader.js?v=3.1.2','./farm-game/game.js?v=3.1.1','./farm-game/asset-loader.js?v=2.1.0','./farm-game/assets/manifest.json?v=3.0.0','./farm-game/LICENSE_SOURCE.txt',
