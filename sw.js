const CACHE_NAME='linh-kanban-static-v746-crop-capture-music';
const ASSETS=[
  './','./index.html','./styles.css?v=6.23','./dragdrop.js?v=3.3','./app.js?v=3.7','./music-player.js?v=3.3','./capture-launcher.js?v=1.0.0',
