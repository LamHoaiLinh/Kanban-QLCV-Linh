const CACHE_NAME='linh-kanban-static-v511-office-ui-tarot-prompt';
const ASSETS=[
  './','./index.html','./styles.css?v=5.10','./dragdrop.js?v=3.3','./app.js?v=3.7','./music-player.js?v=3.2',
  './office-tools/office-tools.css?v=3.5','./office-tools/office-tools.js?v=3.5','./office-tools/vendor/jszip.min.js',
