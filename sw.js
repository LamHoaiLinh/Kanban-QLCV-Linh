const CACHE_NAME='linh-kanban-static-v640-dice-beast-race';
const ASSETS=[
  ...
  './dice-launcher.js?v=6.0','./dice-game/index.html?v=6.0.0','./dice-game/styles.css?v=6.0.0','./dice-game/js/app.js?v=6.0.0','./dice-game/js/d10-engine.js?v=6.0.0','./dice-game/assets/D10.glb',
