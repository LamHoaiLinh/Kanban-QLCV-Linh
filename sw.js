const CACHE_NAME='linh-kanban-static-v50-dice-tarot';
const ASSETS=[
  ...
  './dice-launcher.js?v=5.0','./dice-game/index.html?v=5.0.0','./dice-game/styles.css?v=5.0.0','./dice-game/js/app.js?v=5.0.0',
  './tarot-launcher.js?v=5.0','./tarot-game/index.html?v=5.0.0','./tarot-game/styles.css?v=5.0.0','./tarot-game/js/app.js?v=5.0.0','./tarot-game/js/tarot-data.js',
