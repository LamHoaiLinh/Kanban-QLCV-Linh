const CACHE_NAME='linh-kanban-static-v720-dice-arena-polish';
const ASSETS=[
  ...
  './dice-game/index.html?v=7.2.0','./dice-game/styles.css?v=7.2.0','./dice-game/js/app.js?v=7.2.0','./dice-game/js/d10-engine.js?v=7.2.0','./dice-game/assets/D10.glb',
