const CACHE_NAME='linh-kanban-static-v729-tinhnhanh-keypadfixed';
const ASSETS=[
  ...
  './tarot-game/LICENSE_SOURCE.txt','./tinh-nhanh-game/index.html?v=3.1.3','./tinh-nhanh-game/styles.css?v=3.1.3','./tinh-nhanh-game/skills.js?v=3.1.3','./tinh-nhanh-game/core.js?v=3.1.3','./tinh-nhanh-game/app.js?v=3.1.3','./tinh-nhanh-game/assets/icon-256.png','./tinh-nhanh-game/LICENSE_SOURCE.txt','./tinh-nhanh-game/SOURCE_INFO.txt','./manifest.webmanifest?v=3.2','./assets/icon.svg',
