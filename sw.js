const CACHE_NAME='linh-kanban-static-v522-farm-v301';
const ASSETS=[
  ...
  './game-launcher.js?v=1.0','./farm-game/index.html?v=3.0.1','./farm-game/styles.css?v=3.0.1','./farm-game/asset-loader.css?v=2.0.0','./farm-game/config.js?v=2.0.0','./farm-game/game.js?v=3.0.1','./farm-game/asset-loader.js?v=2.0.0','./farm-game/assets/manifest.json?v=2.0.0','./farm-game/LICENSE_SOURCE.txt',
