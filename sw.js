const CACHE_NAME='linh-kanban-static-v54-d10-glb';
const ASSETS=[
  ...
  './dice-launcher.js?v=5.4','./dice-game/index.html?v=5.4.0','./dice-game/styles.css?v=5.4.0','./dice-game/js/app.js?v=5.4.0','./dice-game/js/d10-engine.js?v=5.4.0','./dice-game/assets/D10.glb',
