const CACHE_NAME='linh-kanban-static-v751-capture-text-controls';
const ASSETS=[
  './','./index.html','./styles.css?v=6.24','./dragdrop.js?v=3.3','./app.js?v=3.7','./music-player.js?v=3.3','./capture-launcher.js?v=1.4.1',
